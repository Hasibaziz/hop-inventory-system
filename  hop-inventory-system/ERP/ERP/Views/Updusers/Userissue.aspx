<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Upduser.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.InvuserissueEntity>" %>
...
<% using (Html.BeginForm("Userissue", "Updusers"))
   { %>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#RecordsContainer').jtable({
             ...
             actions: {
                 listAction: '<%=Url.Content("~/Updusers/UserissueitemList") %>',
...
<script type="text/javascript">
    $('#LocID').change(function () {
        $.post('<%: ResolveUrl("~/Updusers/AutoITRF?Locname=")%>' + $("#LocID option:selected").text(), function (data) {
            //alert(data.TotalissueQty);
