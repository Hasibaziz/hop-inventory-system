<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Upduser.Master" Inherits="System.Web.Mvc.ViewPage<dynamic>" %>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#RecordsContainer').jtable({
             ...
             actions: {
                 listAction: '<%=Url.Content("~/Updusers/ModelsList") %>',
                 //deleteAction: '<%=Url.Content("~/Inventory/DeleteModelsRecord") %>',
                 updateAction: '<%=Url.Content("~/Updusers/AddUpdateModels") %>',
                 createAction: '<%=Url.Content("~/Updusers/AddUpdateModels") %>'
