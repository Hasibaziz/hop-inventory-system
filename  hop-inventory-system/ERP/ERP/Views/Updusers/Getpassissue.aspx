<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Upduser.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.InvgetpassissuereportEntity>" %>
...
<script type="text/javascript">
    function printItem() {
//        alert("Report");
        window.open("/Updusers/Getpassissuerpt");
    }
</script>
<script type="text/javascript">
    ...
    $('input#IssueDate').change(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            actions: {
                listAction: '/Updusers/GetpassissueByDate?issuedate=' + $("#IssueDate ").val()
            },
            fields: {
                //                RIssueID: {
                //                    key: true,
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Updusers/GetpassissueList") %>'
