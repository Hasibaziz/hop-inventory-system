 ...
 <% Html.Telerik().Menu().HtmlAttributes(new { style = "color: Black !important" })
            ...
            .Items(menu =>
            {
                ...
                menu.Add()
                  ...
                  .Items(item =>
                  {
                      item.Add().Text("User Issue Item").ImageUrl("~/Content/Common/Icons/Suites/orm.png").Url("~/OPEX/Userissue");
                      item.Add().Text("FTY Transfer").ImageUrl("~/Content/Common/Icons/Suites/mvc.png").Url("~/OPEX/Assetdist");
                ...
                menu.Add()
                    ...
                    .Items(item =>
                    {
                        item.Add().Text("OPEX Factory Wise Stock").ImageUrl("~/Content/Common/Icons/Suites/win.png").Url("~/OPEX/FTYStock");
