...
<div class="mp_left_menu"><div class="scroll-text" style="background-color: #DB7093; font: Arial;">Add Unit</div></div>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#RecordsContainer').jtable({
             ...
             actions: {
                 listAction: '<%=Url.Content("~/Inventory/UnitinfoList") %>',
                 //                 deleteAction: '<%=Url.Content("~/Inventory/DeleteItemsRecord") %>',
                 updateAction: '<%=Url.Content("~/Inventory/AddUpdateUnitInfo") %>',
                 createAction: '<%=Url.Content("~/Inventory/AddUpdateUnitInfo") %>'
