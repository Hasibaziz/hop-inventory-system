<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ERP.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.InvuserissueEntity>" %>
...
<% using (Html.BeginForm("Userissue", "Inventory"))
   { %>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#RecordsContainer').jtable({
             ...
             actions: {
                 listAction: '<%=Url.Content("~/Inventory/UserissueitemList") %>',
...
<script type="text/javascript">
    $('#LocID').change(function () {
        $.post('<%: ResolveUrl("~/Inventory/AutoITRF?Locname=")%>' + $("#LocID option:selected").text(), function (data) {
            //alert(data.TotalissueQty);
