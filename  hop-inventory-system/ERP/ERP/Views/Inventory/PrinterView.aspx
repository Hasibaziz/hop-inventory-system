...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            pageSize: 10,
            sorting: false,
            title: 'The Printer List',
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Inventory/PrinterDetailsList") %>'
            },
            fields: {
                AccountID: {
                    key: true,
                ...
                AccountCode: {
                    ...
                    display: function (data) {
                        return '<a href="/Inventory/PrinterDetailsbyID/' + data.record.AccountID + '">' + data.record.AccountCode + '</a>';
                    }
                },
                EMPID: {
                    title: 'Employee ID',
