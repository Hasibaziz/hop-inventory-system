<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ERP.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.InvallstockEntity>" %>
...
<script type="text/javascript">
    function impexcel() {
        //alert("Report");
        window.open("/Inventory/StockinfoByDateExcel?StartDate=" + $("#StartDate").val() + "&EndDate=" + $("#EndDate").val() + "&ItemID=" + $("#ItemID").val() + "&ModelID=" + $("#ModelID").val());
    }
</script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            defaultSorting: 'Name ASC',
            actions: {
                listAction: '<%=Url.Content("~/Inventory/StockinfoList") %>',
...
//            defaultSorting: 'Name ASC',
//            actions: {
//                listAction: '<%=Url.Content("~/Inventory/StockinfoByDate") %>',
//                //updateAction: '<%=Url.Content("~/Inventory/Additemreceive") %>'
//            },
//            fields: {
//                SID: {
