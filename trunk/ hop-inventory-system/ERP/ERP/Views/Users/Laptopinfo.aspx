<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Users.Master" Inherits="System.Web.Mvc.ViewPage<ERP.Domain.Model.InvInventorydetailsEntity>" %>
...
<div class="mp_left_menu">
   <div class="scroll-text" style="background-color: #DB7093; font: Arial;">Laptop Info</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#RecordsContainer').jtable({
            ...
            actions: {
                listAction: '<%=Url.Content("~/Users/LaptopinfoList") %>'
            },
            fields: {
                AccountID: {
                    key: true,
